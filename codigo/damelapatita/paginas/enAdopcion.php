                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-9" id="barrica">
                            ...
                            <form action="enAdopcion.php" method="get" class="form-horizontal" id="filtroForm">
                                ...
                                <div class="col-xs-12 pull-right" id="contenedorSubmit">
                                    <input type="submit" id="btnEnviar" class="btn btn-danger col-xs-12">
                                </div>
                            ...
                            try{
                                ...
                                $num = cantidadAnimalesAdoptados(2, $tipoBusqueda, $provinciaBusqueda);
                                $num->execute();
                                $x = $num->fetch();
                                $total = ceil($x[0] / $limit_end);

                                // Consulta para presentar los animales
                                $animalicos = animalesAdopcion(2, $init, $limit_end, $tipoBusqueda, $provinciaBusqueda);
                                $animalicos->execute();
                                ...
                                while ($resultado = $animalicos->fetch()){
                                    ...
                                    echo $resultado['nombre'] . ', ' . cadenaEdad($resultado['edad']);
